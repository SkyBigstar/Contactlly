	...
	render() {
		...
		return (
				<div>
					...
					<MainBody>
						<div style={{fontSize:"xx-large", marginBottom:"50px"}}>Templates&nbsp;&nbsp; 
...
export const Divider = () => <div className="divide-y-2 divide-dashed divide-gray-300 mb-6 md:mb-8"> <div></div>
	<div></div></div>

export const Title = ({ title }) => <h2 className="text-xl sm:text-2xl md:text-2xl text-gray-700 mt-4 md:mt-6">
	{title}
</h2>
