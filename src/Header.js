		...
		return (
			<>
				<div className="border-gray-300 bg-white flex" style={{ height: "82px"}}>
					<div className="md:left-0 md:top-0 md:fixed container flex select-none justify-between bg-white " style={{ zIndex: "999",  maxWidth: "100%", boxShadow:"0 0 18px 0 rgba(0, 0, 0, .12)", position:"fixed" }}>
						<div className="flex items-center">
							<div className="flex items-center justify-items-center" style={{ height: "82px", width: "257px", borderRightWidth: "1px" ,borderBottomWidth: "1px" }}>
								<img src="/logo/128867375.png" alt="AI to Social" style={{ height: "41px", width: "auto", marginLeft: "auto", marginRight: "auto" }} />
							</div>
							<div className="mx-6" style={{ display: "inline-block", height: "35px", width: "35px", background: "rgba(116,16,162,0.2)", textAlign: "center", lineHeight: "35px", borderRadius: "50%", fontSize: "14px", color: "rgba(116,16,162,1)", marginRight: "0px", cursor: "pointer" }} onClick={this.changeSidebarClick}>
								<i className="fa fa-bars"></i>
							</div>
							<div className="mx-6" style={{ display: "inline-block", height: "35px", width: "35px", background: "rgba(116,16,162,0.2)", textAlign: "center", lineHeight: "35px", borderRadius: "50%", fontSize: "14px", color: "rgba(116,16,162,1)", marginLeft: "10px", cursor: "pointer" }} onClick={() => this.go_full_screen()}>
						...
						<div className="flex items-center" style={{borderLeftWidth: "1px", borderRightWidth: "1px" , paddingLeft: "25px", paddingRight: "25px"}}>	
								<div id="pop" style={{ display: "inline-block", height: "35px", width: "35px", background: "rgba(116,16,162,0.2)", textAlign: "center", lineHeight: "35px", borderRadius: "50%", fontSize: "14px", color: "rgba(116,16,162,1)" , cursor: "pointer"}} onClick={this.handlepopupmenuChange}>
									<i className="fas fa-user"></i>
								</div>
						</div>
						{this.state.showpopmenu && Popmenu()}
...
const Popmenu = () => {
	...
	return (
		<>
			<div style={{position:"absolute", right: "35px", top:"70px", height:"30", borderLeft:"8px solid transparent", borderRight:"8px solid transparent", borderBottom:"8px solid #d7d7d7"}}></div>
			<div className='absolute right-5 top-20' style={{padding:"5px", borderRadius:"4px", background:"white",boxShadow:"0 2px 5px 0 rgba(0, 0, 0, .12)"}}>
				<ul style={{listStyle: 'none', padding:"5px"}} className='popmenu'>
					<li style={{padding: "0px 20px", width:"180px", textAlign:"left", background:"white"}}>
					<Link
						className={
